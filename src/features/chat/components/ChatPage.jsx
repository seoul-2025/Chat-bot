                    ...
                    >
                      {message.type === "user" ? (
                        ...
                        <StreamingAssistantMessage
                          content={streamingContent || "답변 생성중..."}
        ...
        <div className={clsx(
          ...
          <fieldset className="flex w-full min-w-0 flex-col px-16">
            ...
            >
              ...
              <div className="flex flex-col gap-1 mx-2.5 mt-0.5 mb-1">
                <div className="relative">
                    ...
                    >
                      <span className="truncate max-w-20">
                        {selectedModel === 'claude-opus-4-5-20251101' ? 'Opus 4.5' :
                         ...
                         selectedModel === 'claude-opus-4-20250514' ? 'Opus 4.1' : 'Opus 4.5'}
                      </span>
                      <svg
                      ...
                      >
                        <div className="p-1">
                          {[
                            ...
                            { id: 'claude-opus-4-20250514', name: 'Opus 4.1', desc: 'Previous generation model' }
                          ].map((model) => (
                            <button
                              key={model.id}
                              onClick={() => {

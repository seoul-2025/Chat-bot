    ...
    <div className="w-full max-w-4xl pt-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-text-300">
          {selectedEngine === "11"
            ? "실적·신제품·투자·M&A·인사 등 기업 관련 보도자료를 작성합니다."
            : "정책·통계·예산·규제·해명 등 정부/공공 관련 보도자료를 작성합니다."}
        </p>
      </div>
        ...
        >
          ...
          <div>
            <p className="text-sm text-text-200">
              <span className="font-medium">시작하는 방법:</span> 입력창에
              주제나 키워드를 입력하고 전송 버튼을 클릭하세요
            </p>
          </div>
        </div>

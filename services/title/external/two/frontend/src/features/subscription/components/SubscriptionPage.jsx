...
const SubscriptionPage = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: '박민수',
      role: '디지털 에디터',
      comment: 'C7 엔진의 창의적인 제목 생성 능력이 인상적입니다. 업무 효율이 3배 향상되었어요.',
      plan: '프리미엄 플랜'
    },
    {
      name: '이소영',
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="pt-20 pb-32 text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg lg:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 md:mb-16 font-light">
              <span className="block md:inline">T5와 C7 엔진으로</span>
              <span className="block md:inline md:ml-1">클릭률을 높이는 매력적인 제목을</span>
        ...
        <div className="mb-32">
          <div className="text-center mb-20">
            ...
            <p className="text-base md:text-lg lg:text-2xl text-slate-600 max-w-4xl mx-auto font-light leading-relaxed">
              <span className="block md:inline">클릭률을 높이는 매력적인 제목으로</span>
          ...
          <div className="grid lg:grid-cols-3 gap-10 mb-20">
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm md:text-base lg:text-lg">
                <span className="block md:inline">제목 작성 시간을 <span className="font-semibold text-slate-900">90% 단축</span>하고</span>{' '}
                <span className="block md:inline"><span className="font-semibold text-slate-900">클릭률은 35% 향상</span>시킵니다.</span>{' '}
                <span className="block md:inline">다양한 옵션 중 최적의 제목을 선택할 수 있습니다.</span>
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-slate-200">
                  {[
                    ...
                    { feature: 'C7 엔진', free: '기본', basic: '고급', premium: '전문가급' },
        ...
        <div className="text-center bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-8 md:p-12 lg:p-16 mb-20 shadow-2xl">
          ...
          <p className="text-base md:text-lg lg:text-xl text-slate-300 mb-8 md:mb-12 max-w-2xl mx-auto font-light">
            <span className="block md:inline">AI 제목 생성으로</span>
            <span className="block md:inline md:ml-1">당신의 콘텐츠를 더욱 매력적으로 만들어보세요</span>
          </p>

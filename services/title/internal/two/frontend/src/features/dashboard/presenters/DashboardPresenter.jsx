  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data}>
        ...
        <Area type="monotone" dataKey="C7" stroke="hsl(210, 70.9%, 51.6%)" fillOpacity={1} fill="url(#colorC7)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  </motion.div>
);
  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <RadarChart data={data}>
        ...
        <Radar name="C7" dataKey="C7" stroke="hsl(210, 70.9%, 51.6%)" fill="hsl(210, 70.9%, 51.6%)" fillOpacity={0.3} strokeWidth={2} />
        <Legend />
      </RadarChart>
    </ResponsiveContainer>
  </motion.div>
...
const UsageOverviewSection = ({ usageData }) => (
  ...
  >
    ...
    <EngineUsageCard engine="C7" data={usageData.C7} color="hsl(210, 70.9%, 51.6%)" />
  </motion.div>
);

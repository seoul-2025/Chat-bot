    ...
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data}>
        <defs>
          ...
          <linearGradient id="colorC7" x1="0" y1="0" x2="0" y2="1">
        ...
        <Legend />
        <Area type="monotone" dataKey="C1" stroke="hsl(251, 40.2%, 54.1%)" fillOpacity={1} fill="url(#colorT5)" strokeWidth={2} />
        <Area type="monotone" dataKey="C2" stroke="hsl(210, 70.9%, 51.6%)" fillOpacity={1} fill="url(#colorC7)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  </motion.div>
);
  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <RadarChart data={data}>
        ...
        <Radar name="C1" dataKey="C1" stroke="hsl(251, 40.2%, 54.1%)" fill="hsl(251, 40.2%, 54.1%)" fillOpacity={0.3} strokeWidth={2} />
        <Radar name="C2" dataKey="C2" stroke="hsl(210, 70.9%, 51.6%)" fill="hsl(210, 70.9%, 51.6%)" fillOpacity={0.3} strokeWidth={2} />
        <Legend />
      </RadarChart>
    </ResponsiveContainer>
  </motion.div>
...
const UsageOverviewSection = ({ usageData }) => (
  ...
  >
    <EngineUsageCard engine="C1" data={usageData.T5} color="hsl(251, 40.2%, 54.1%)" />
    <EngineUsageCard engine="C2" data={usageData.C7} color="hsl(210, 70.9%, 51.6%)" />
  </motion.div>
);

  ...
  >
    ...
    <ResponsiveContainer width="100%" height={300}>
      <AreaChart data={data}>
        ...
        <Legend />
        <Area type="monotone" dataKey="11" stroke="hsl(251, 40.2%, 54.1%)" fillOpacity={1} fill="url(#colorT5)" strokeWidth={2} />
        <Area type="monotone" dataKey="22" stroke="hsl(210, 70.9%, 51.6%)" fillOpacity={1} fill="url(#colorC7)" strokeWidth={2} />
      </AreaChart>
    </ResponsiveContainer>
  </motion.div>
);
...
const UsageOverviewSection = ({ usageData }) => (
  ...
  >
    <EngineUsageCard engine="11" data={usageData.T5} color="hsl(251, 40.2%, 54.1%)" />
    <EngineUsageCard engine="22" data={usageData.C7} color="hsl(210, 70.9%, 51.6%)" />
  </motion.div>
);

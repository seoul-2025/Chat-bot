...
conversations_table = dynamodb.Table(os.environ.get('CONVERSATIONS_TABLE', 'tem1-conversations-v2'))
...
class ConversationManager:
    ...
    @staticmethod
    def create_or_update_conversation(conversation_id: str, engine_type: str = '11', title: str = None):
        """대화 생성 또는 메타데이터 업데이트"""
        try:
            timestamp = datetime.utcnow().isoformat() + 'Z'

...
class UsageService:
    ...
    COST_PER_1K_INPUT_TOKENS = {
        'C1': Decimal('0.003'),   # Claude Sonnet 입력 토큰 비용
        'C2': Decimal('0.015')    # Claude Opus 입력 토큰 비용
    }

    COST_PER_1K_OUTPUT_TOKENS = {
        'C1': Decimal('0.015'),   # Claude Sonnet 출력 토큰 비용
        'C2': Decimal('0.075')    # Claude Opus 출력 토큰 비용
    }

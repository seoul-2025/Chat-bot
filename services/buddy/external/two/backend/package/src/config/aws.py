...
# DynamoDB 테이블 설정
DYNAMODB_TABLES = {
    'conversations': os.environ.get('CONVERSATIONS_TABLE', 'p2-two-conversations-two'),
    'prompts': os.environ.get('PROMPTS_TABLE', 'p2-two-prompts-two'),
    'files': os.environ.get('FILES_TABLE', 'p2-two-files-two'),
    'usage': os.environ.get('USAGE_TABLE', 'p2-two-usage-two'),
    'connections': os.environ.get('CONNECTIONS_TABLE', 'p2-two-websocket-connections-two')
}

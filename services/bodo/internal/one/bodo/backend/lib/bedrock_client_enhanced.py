...
# TOP_P = BEDROCK_CONFIG.get('top_p')  # ❌ Claude Sonnet 4는 temperature와 함께 사용 불가
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
## 📚 [9. WEB SEARCH CITATION - 웹 검색 출처 표시]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- 타임존: Asia/Seoul (KST)
- 세션 ID: {session_id}
- 날짜 기준: 오늘은 {current_time.strftime('%Y년 %m월 %d일')} 입니다.
"""

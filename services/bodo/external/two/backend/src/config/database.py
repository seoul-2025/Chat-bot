...
TABLES = {
    'conversations': {
        'name': os.environ.get('CONVERSATIONS_TABLE', 'w1-conversations-v2'),
    ...
    'prompts': {
        'name': os.environ.get('PROMPTS_TABLE', 'w1-prompts-v2'),
    ...
    'usage': {
        'name': os.environ.get('USAGE_TABLE', 'w1-usage'),
        'partition_key': 'userId',
    ...
    'websocket_connections': {
        'name': os.environ.get('WEBSOCKET_TABLE', 'w1-websocket-connections'),
        'partition_key': 'connectionId'
    },
    'files': {
        'name': os.environ.get('FILES_TABLE', 'w1-files'),
        'partition_key': 'promptId',
        'sort_key': 'fileId'
    }
}

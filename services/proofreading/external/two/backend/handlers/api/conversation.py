...
def handler(event, context):
    ...
    try:
        ...
        elif http_method == 'GET' and (path_params and ('conversationId' in path_params or 'id' in path_params)):
        ...
        elif http_method == 'DELETE' and (path_params and ('conversationId' in path_params or 'id' in path_params)):
            conversation_id = path_params.get('conversationId') or path_params.get('id')

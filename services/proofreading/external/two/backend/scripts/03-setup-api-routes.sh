...
# Lambda 함수 ARN
USAGE_LAMBDA_ARN="arn:aws:lambda:${REGION}:887078546492:function:nx-wt-prf-usage-handler"
CONVERSATION_LAMBDA_ARN="arn:aws:lambda:${REGION}:887078546492:function:nx-wt-prf-conversation-api"

...
const SubscriptionPage = () => {
  ...
  const [selectedEngine, setSelectedEngine] = useState('Basic');

  useEffect(() => {
    const loadUserInfo = () => {
      try {
        const storedUserInfo = localStorage.getItem('userInfo');
        const storedEngine = localStorage.getItem('selectedEngine') || 'Basic';
  ...
  const testimonials = [
    {
      name: '김지연',
      role: '콘텐츠 마케터',
      comment: '비즈니스 모드로 교열한 기사의 품질이 평균 35% 향상되었습니다. 정말 놀라운 도구예요.',
      plan: '베이직 플랜'
    },
    {
      name: '박민수',
      role: '디지털 에디터',
      comment: '종합 뉴스 모드의 정밀한 교정 능력이 인상적입니다. 업무 효율이 3배 향상되었어요.',
      plan: '프리미엄 플랜'
    },
    {
      name: '이소영',
      role: '프리랜서 작가',
      comment: '무료 플랜만으로도 충분히 유용합니다. 특히 빠른 문서 검토에 큰 도움이 됩니다.',
      plan: '무료 플랜'
    }
  ];
      ...
      <div className="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div className="pt-20 pb-32 text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg lg:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed mb-10 md:mb-16 font-light">
              <span className="block md:inline">비즈니스·종합 뉴스 모드로</span>
              <span className="block md:inline md:ml-1">오류 없는 완벽한 문서를</span>
              <br className="hidden sm:block" />
              <span className="text-slate-900 font-medium">빠르고 정확하게</span> 교정하세요
            </p>
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-sm text-slate-500 mb-1">사용 중인 모드</div>
                <div className="font-semibold text-slate-900">
                  {selectedEngine === 'Basic' ? '비즈니스 모드' : '종합 뉴스 모드'}
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="mb-32">
          <div className="text-center mb-20">
            ...
            <p className="text-base md:text-lg lg:text-2xl text-slate-600 max-w-4xl mx-auto font-light leading-relaxed">
              <span className="block md:inline">오류 없는 완벽한 문서로</span>
              <span className="block md:inline md:ml-1">콘텐츠의 신뢰도를 극대화하세요</span>
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-10 mb-20">
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm md:text-base lg:text-lg">
                ...
                문맥을 고려한 정밀한 교정을 제공합니다. 전문적인 문체와 어휘를 제안합니다.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-slate-600 leading-relaxed text-sm md:text-base lg:text-lg">
                <span className="block md:inline">교열 시간을 <span className="font-semibold text-slate-900">90% 단축</span>하고</span>{' '}
                <span className="block md:inline"><span className="font-semibold text-slate-900">문서 품질은 35% 향상</span>시킵니다.</span>{' '}
                <span className="block md:inline">다양한 교정 제안 중 최적의 수정안을 선택할 수 있습니다.</span>
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-slate-200">
                  {[
                    ...
                    { feature: '비즈니스 모드', free: '기본', basic: '고급', premium: '전문가급' },
                    { feature: '종합 뉴스 모드', free: '기본', basic: '고급', premium: '전문가급' },
                    { feature: '교열 횟수', free: '5회', basic: '무제한', premium: '무제한' },
        ...
        <div className="text-center bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-8 md:p-12 lg:p-16 mb-20 shadow-2xl">
          ...
          <p className="text-base md:text-lg lg:text-xl text-slate-300 mb-8 md:mb-12 max-w-2xl mx-auto font-light">
            <span className="block md:inline">AI 교열로</span>
            <span className="block md:inline md:ml-1">당신의 문서를 더욱 완벽하게 만들어보세요</span>
          </p>
